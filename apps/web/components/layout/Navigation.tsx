...
const NavPill = styled.nav({
  ...
  boxShadow:
    '0 10px 30px rgba(0, 0, 0, 0.22), inset 0 1px 0 rgba(255, 255, 255, 0.45)',
  borderRadius: '99px',
  padding: '4px',
});
...
const CtaButton = styled(Link)({
  ...
  boxShadow:
    '0 10px 26px rgba(0, 0, 0, 0.22), inset 0 1px 0 rgba(255, 255, 255, 0.35)',
  borderRadius: '99px',
...
const MobileMenuButton = styled.button({
  ...
  WebkitBackdropFilter: 'blur(14px) saturate(160%)',
  boxShadow:
    '0 10px 26px rgba(0, 0, 0, 0.22), inset 0 1px 0 rgba(255, 255, 255, 0.45)',
  borderRadius: '99px',
  width: '48px',
  height: '48px',
  color: colors.textPrimary,
...
const MobileDrawer = styled.nav<{ open: boolean }>(({ open }) => ({
  ...
  gap: '8px',
  boxShadow:
    '0 18px 40px rgba(0, 0, 0, 0.28), inset 0 1px 0 rgba(255, 255, 255, 0.45)',
  pointerEvents: 'auto',
...
const MobileCta = styled(Link)({
  ...
  boxShadow:
    '0 10px 26px rgba(0, 0, 0, 0.18), inset 0 1px 0 rgba(255, 255, 255, 0.35)',
});
    ...
    <Header>
      <Inner>
        ...
        <MobileBar>
          ...
          <MobileMenuButton type="button" aria-label="메뉴 열기" onClick={() => setOpen((prev) => !prev)}>
            ≡
          </MobileMenuButton>
        </MobileBar>
