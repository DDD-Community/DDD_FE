...
const FAQ_ITEMS: FaqItem[] = [
  ...
  },
  {
    ...
    answer: '네, 없어도 괜찮아요. DDD는 처음 사이드프로젝트를 경험하는 분들도 함께 성장할 수 있는 환경을 제공해요.',
  },
  {
    question: '팀은 어떻게 구성되나요?',
    answer: '기수별로 PM, 디자이너, 개발자(iOS, AOS, WEB)가 함께하는 팀으로 구성되며, 모집 과정에서 적절히 배정돼요.',
  },
  {
    question: '정기 모임은 어떻게 진행되나요?',
    answer: '격주 토요일에 오프라인 정기 모임이 진행되며, 팀 프로젝트 진행 상황 공유 및 네트워킹 시간을 가져요.',
  },
  {
    question: '한 기수 활동 기간은 얼마나 되나요?',
    answer: '한 기수는 약 6개월로 구성되며, 기수 종료 시 데모데이를 통해 팀별 프로젝트 결과물을 발표해요.',
  },
];
