...
export const articleBanner = {
  desktop: 'https://www.figma.com/api/mcp/asset/c8d4e517-34a9-4d2d-a0a3-73603bd3361c',
  tablet: 'https://www.figma.com/api/mcp/asset/77c0b6b8-2c3a-4b10-a41f-b3b942553b2d',
} as const;
